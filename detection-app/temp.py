...
class IntrusionDetectionApp(tk.Tk):
    ...
    def create_main_menu(self):
        ...
        live_detection_button = tk.Button(self, text="< Live Detection >", font=("Segoe UI", 14, "bold"), bg="#75EB51",
        ...
        live_detection_button.bind("<Enter>",
                                   lambda event, btn=live_detection_button: btn.config(bg="#75EB51", fg="black"))
        live_detection_button.bind("<Leave>",
                                   lambda event, btn=live_detection_button: btn.config(bg="#75EB51", fg="black"))

        # Use File Button
        use_file_button = tk.Button(self, text="< Use File >", font=("Segoe UI", 14, "bold"), bg="#E91236", fg="black",
                                    bd=2,
                                    cursor="hand2", relief="raised", command=self.use_file,
                                    padx=20, pady=10, width=15)
        use_file_button.pack(side="top", pady=40)
        use_file_button.bind("<Enter>", lambda event, btn=use_file_button: btn.config(bg="#E91236", fg="black"))
        use_file_button.bind("<Leave>", lambda event, btn=use_file_button: btn.config(bg="#E91236", fg="black"))
    ...
    def live_detection(self):
        ...
        import subprocess
        os.chdir(sys.path[0])
        subprocess.Popen([r'C:\Users\Jmbin\AppData\Local\pypoetry\Cache\virtualenvs\ids-master-4UCKAg9M-py3.10\Scripts\activate && cicflowmeter -i "WiFi" -c live_capture.csv'], shell=True)
